      ...
      <div className="glass-panel" style={{ width: '100%', maxWidth: '440px', padding: '3rem 2rem' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ margin: 0, fontSize: '0.9rem' }}>
            {isLogin ? 'Enter your credentials to access your account' : 'Join the elite chesspunk community'}
          </p>
        </div>
        ...
        <form onSubmit={handleAuth}>
          {!isLogin && (
            <div className="form-group">
              ...
              <input type="text" className="input-field" placeholder="Grandmaster Name" required />
            </div>
          )}
